...
#' library(raster)
#' a <- raster(nc=2, nr=2)
#' values(a)<-runif(ncell(a),min =0.2,max= 0.8)
#' c <- brick(nc=2, nr=2, nl=2)
#' values(c)<-runif(ncell(c),min =169076.9,max= 924474.6)
#' b <- brick(nc=2, nr=2, nl=2)
#' values(b)<-runif(ncell(b),min = 278,max= 281)
#'  LUE_BIOMASS(a,c,b,-2,12,3)
