#' @title Light Use Efficiency Model to Estimate Crop Yield with Vapour Pressure Deficit
#' @usage LUE_YIELD_VPD(fpar_raster,par,tmin,tmax,tdew,
#' tmin_min,tmin_max,vpd_max, vpd_min,LUE_optimal)
#' @format A Biomass raster
#' @description LUE_YIELD_VPD() to estimate crop yield firstly by calculating the Absorbed Photosynthetically Active Radiation (APAR) and secondly the actual values of light use efficiency by including vapour pressure deficit of the crops Shi et al.(2007) <doi:10.2134/agronj2006.0260>.
...
LUE_YIELD_VPD<-function(fpar_raster,par,tmin,tmax,tdew,tmin_min,tmin_max,vpd_max, vpd_min,LUE_optimal) {
